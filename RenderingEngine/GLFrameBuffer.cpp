...
FrameBuffer::FrameBuffer(void) : renderBuffer(0) {
...
bool FrameBuffer::CreateGeneralFBO(int width, int height, int colorBuffers, bool depthBuffer) {
	...
	if (depthBuffer) {
		Texture *depth = new Texture(GL_TEXTURE_2D);
		depth->Bind();
